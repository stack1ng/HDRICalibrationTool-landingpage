			...
			<main className="px-6 py-16">
				...
				<section className="mt-12 max-w-3xl">
					...
					<ul className="space-y-2 text-zinc-700 dark:text-zinc-300">
						<li>
							• Upload multiple exposure photos and generate calibrated HDR
							luminance maps in one workflow
						</li>
						<li>
							• Configure camera response and calibration data through a guided
							interface
						</li>
						<li>
							• Compare HDR outputs side-by-side for analysis and validation
						</li>
				...
				<section className="mt-12 max-w-3xl">
					...
					<p className="text-zinc-700 dark:text-zinc-300">
						HDR image calibration typically requires multiple command-line tools
						such as Radiance and hdrgen, which can be difficult to configure and
						error-prone for new users. This slows down lighting analysis
						workflows in research and design.
					</p>
					<p className="mt-3 text-zinc-700 dark:text-zinc-300">
						This application was built to make HDR calibration more accessible,
						reproducible, and efficient through a visual interface.
					</p>
				</section>
